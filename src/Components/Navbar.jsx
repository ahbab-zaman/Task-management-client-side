...
const Navbar = () => {
  ...
  return (
    <nav className="bg-base-100 shadow-md fixed w-full h-[64px] z-50">
      ...
      ></div>
      <div
        className={`fixed top-0 right-0 h-full w-64 bg-base-100 shadow-lg transform transition-transform duration-300 ease-in-out
